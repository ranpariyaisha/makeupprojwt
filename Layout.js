    ...
    return(
        ...
        <div className="container"> 
            <div className="row" >
                ...
                <div className='col border border-secondary ' ><Link to="/makeup">Allsummery</Link> </div>
                <div className='col border border-secondary ' ><Link to="/makeup/add">AddNewEntery</Link> </div>
            </div>
            <div className='row'>
